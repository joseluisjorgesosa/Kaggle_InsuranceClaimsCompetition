...
def get_predictions_rf(train_file, test_file):
	...
	clf = Pipeline([
	  ('feature_selection', SelectFromModel(
	  	RandomForestClassifier(verbose=1, n_jobs=-1, n_estimators=100,max_features= 'sqrt',criterion= 'entropy',min_samples_split= 5,
	                            max_depth= 50, min_samples_leaf= 5), threshold='0.5*mean')),
	  ('classification', RandomForestClassifier(verbose=1, n_jobs=-1, n_estimators=100,max_features= 'sqrt',criterion= 'entropy',min_samples_split= 5,
...
def get_predictions_et(train_file, test_file):
	print "about to start"
	...
	clf = Pipeline([
	  ('feature_selection', SelectFromModel(
	  	ExtraTreesClassifier(verbose=1, n_jobs=-1, n_estimators=100,max_features= 'sqrt',criterion= 'entropy',min_samples_split= 5,
	                            max_depth= 50, min_samples_leaf= 5), threshold='0.5*mean')),
	  ('classification', ExtraTreesClassifier(verbose=1, n_jobs=-1, n_estimators=100,max_features= 'sqrt',criterion= 'entropy',min_samples_split= 5,
	                            max_depth= 50, min_samples_leaf= 5) 
		)
	])
	print "about to fit"
